...
public class CustomerRestController {
	...
	@GetMapping(value ="/updateproduct/{customerId}",produces ="application/json")
	public String updateProductByCustomerId(@PathVariable int customerId) {
		return service.updateProductByCustomerId(customerId);
	}
